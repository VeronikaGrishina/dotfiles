...
(custom-set-variables
 ...
 '(custom-safe-themes
   '("014cb63097fc7dbda3edf53eb09802237961cbb4c9e9abd705f23b86511b0a69"
     default))
 '(org-agenda-files '("~/Documents/Notes/Org/20250101.gpg"))
 '(package-selected-packages
   '(async company doom-themes habitica org-journal rust-mode
	   yasnippet-snippets))
 '(package-vc-selected-packages '((helm :url "https://github.com/emacs-helm/helm"))))
(custom-set-faces
